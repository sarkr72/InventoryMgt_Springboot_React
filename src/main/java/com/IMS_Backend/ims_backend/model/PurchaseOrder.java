...
public class PurchaseOrder {
	...
	@JsonIgnoreProperties({"id", "firstName", "lastName", "email", "password", "phone", "role", "company", "companyId" })
	private Employee employee;

	@ManyToOne(optional = false)
	@JoinColumn(name = "company", nullable = false)
	@JsonIgnoreProperties({"id", "employees", "warehouses", "suppliers"})
	...
	@JsonIgnoreProperties({"id", "companies"})
	...
	public PurchaseOrder(String date, int quantity, double totalAmount, double unitPrice, String po, Employee employee,
			Company company, Set<String> productNames, Supplier supplier) {
		super();
		this.date = date;
