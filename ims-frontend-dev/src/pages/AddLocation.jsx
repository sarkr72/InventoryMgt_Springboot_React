...
const AddLocation = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (location) {
      updateLocation(data.id, data).then((response) => {
  ...
  return (
    <div style={{minHeight: "80vh"}}>
      <div className="text-white shadow-lg mb-5 mt-5 d-flex flex-column col-lg-3 col-md-6 m-auto bg-dark p-4 border rounded-3">
        <div
          style={{
            height: "500px",
            width: "90%",
