...
//	private Supplier supplier;
	...
	public PurchaseOrder(String date, int quantity, double totalAmount, double unitPrice, String po, String employee,
			String company, Set<String> productNames, String supplier) {
		super();
		this.date = date;
